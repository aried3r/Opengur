...
public class ImgurViewFragment extends BaseFragment implements ImgurListener {
    ...
    private static final String KEY_ITEMS = "imgur.object.items.";
    ...
    private void handleArguments(Bundle args, Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            List<ImgurPhoto> photos = StateSaver.instance().getData(savedInstanceState, KEY_ITEMS + mImgurObject.getId());
            ...
            if (photos != null && !photos.isEmpty()) {
                ...
                setupFragmentWithObject(mImgurObject);
            }
        } else {
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        if (mPhotoAdapter != null && !mPhotoAdapter.isEmpty()) {
            try {
                StateSaver.instance().onSaveState(outState, KEY_ITEMS + mImgurObject.getId(), mPhotoAdapter.retainItems());
